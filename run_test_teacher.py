...
from configs.simulation import ConfigTestTeacher
from tasks.simulation.test_teacher import TestTeacher
...
def main():
    ...
    config = ConfigTestTeacher.parse_arguments()
...
def main_worker(local_rank: int, config: argparse.Namespace):
    ...
    if config.enable_wandb:
        wandb.init(
            ...
            project='incomplete-kd-test_teacher',
    ...
    train_params = {
        ...
        'multi_student': {'epochs': config.epochs_multi_student,
                          ...
                          'weight_decay': config.weight_decay_multi_student},
    }
