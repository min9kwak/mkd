...
class Multi(object):
    ...
    def run(self, datasets, save_every: int = 10, **kwargs):
        ...
        for epoch in range(1, self.epochs + 1):
            ...
            # Train and Test
            train_history = self.train(loaders, adjusted=False)
            test_history = self.evaluate(loaders, adjusted=False)
        ...
        # adjusted evaluation
        test_history = self.evaluate(loaders, adjusted=True)
    ...
    def train(self, loaders, adjusted=False):
    ...
    @torch.no_grad()
    def evaluate(self, loaders, adjusted=False):
