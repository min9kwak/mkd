...
class Swap(object):
    ...
    network_names = ['extractor_mri', 'extractor_pet',
                     ...
                     'encoder_general_mri', 'encoder_general_pet',
                     'encoder_mri', 'encoder_pet',
        ...
        with get_rich_pbar(transient=True, auto_refresh=False) as pg:
            ...
            for i, batch in enumerate(data_loader):
                with torch.cuda.amp.autocast(self.mixed_precision):
                    loss, loss_ce, loss_sim, loss_recon, loss_recon_mri, loss_recon_pet, y, logit = \
    ...
    def train_step_ce_only(self, batch):
        ...
        z_mri_general = self.networks['encoder_general_mri'](h_mri)
        z_pet_general = self.networks['encoder_general_pet'](h_pet)
