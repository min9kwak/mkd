...
class MDTPlus(object):
    """MDT⁺ (MDT Plus): Enhanced Multi-modal Teacher via Mutual Transfer.
    
    Enhances the original MDT model by transferring knowledge from the 
    MDT-Student's MRI feature extractor. Since the student was trained with 
