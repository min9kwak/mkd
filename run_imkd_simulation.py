...
from configs.simulation import ConfigSimulationIMKD
from tasks.simulation.imkd import IMKD
...
def main():
    ...
    config = ConfigSimulationIMKD.parse_arguments()
...
def main_worker(local_rank: int, config: argparse.Namespace):
    ...
    train_params = {
        ...
        'imkd': {'epochs': config.epochs_imkd,
                 'learning_rate': config.learning_rate_imkd,
                 'learning_rate_s': config.learning_rate_imkd_s,
                 'weight_decay': config.weight_decay_imkd},
