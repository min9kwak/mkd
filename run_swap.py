...
from configs.slice.swap import SliceSwap
from tasks.slice.swap import Swap
...
from models.slice.build import build_networks_swap
...
def main():
    ...
    config = SliceSwap.parse_arguments()
    config.task = 'Swap-' + config.pet_type.upper()
...
def main_worker(local_rank: int, config: object):
    ...
    # Networks
    networks = build_networks_swap(config=config)
