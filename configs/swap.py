...
class SwapConfig(ConfigBase):

    def __init__(self, args=None, **kwargs):
        super(SwapConfig, self).__init__(args, **kwargs)
    ...
    def model_parser() -> argparse.ArgumentParser:
        ...
        parser.add_argument('--mri_architecture', type=str, choices=('18', '50', 'base', 'small', 'tiny'),
                            default='small')
        parser.add_argument('--mri_pretrained_path', type=str, help='swin/base_ct.pt') # Swin
        ...
        parser.add_argument('--pet_pretrained_path', type=str, help='swin/base_ct.pt') # Swin
        ...
        # Training
        parser.add_argument('--incomplete_ratio', type=int, default=1)
    ...
    def task_specific_parser() -> argparse.ArgumentParser:
        parser = argparse.ArgumentParser('Swap', add_help=False)
        return parser
