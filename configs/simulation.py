...
class ConfigSimulationIMKD(object):
    def __init__(self, args: argparse.Namespace = None, **kwargs):
    ...
    def train_parser() -> argparse.ArgumentParser:
        ...
        parser.add_argument('--train_level', type=parse_numbers, default="1,2,3,4",
                            help='1: single-modal from scratch,'
                                 '2: teacher,'
                                 '3: IMKD (use_specific True and False),'
        ...
        # IMKD
        parser.add_argument('--epochs_imkd', type=int, default=30, help='Number of training epochs.')
        parser.add_argument('--learning_rate_imkd', type=float, default=0.0001, help='Base learning rate to start from.')
        parser.add_argument('--learning_rate_imkd_s', type=float, default=0.0001, help='Base learning rate to start from.')
        parser.add_argument('--weight_decay_imkd', type=float, default=0.0001, help='Weight decay factor.')
...
class ConfigTestTeacher(object):
    def __init__(self, args: argparse.Namespace = None, **kwargs):
