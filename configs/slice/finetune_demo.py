...
class SliceFinetuneDemo(ConfigBase):
    ...
    def task_specific_parser() -> argparse.ArgumentParser:
        ...
        parser.add_argument('--use_cdr', type=str2bool, default=True, help='apply class balance weight')
        parser.add_argument('--scale_demo', type=str2bool, default=True, help='apply class balance weight')
