...
class SliceGeneralTeacher(ConfigBase):
    ...
    def data_parser() -> argparse.ArgumentParser:
        ...
        parser.add_argument('--crop_size_pet', type=int, default=64)
    ...
    def task_specific_parser() -> argparse.ArgumentParser:
        ...
        parser.add_argument('--different_lr', type=str2bool, default=True)
        ...
        parser.add_argument('--alpha_pred', type=float, default=1.0)
