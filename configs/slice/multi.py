...
class SliceMultiConfig(ConfigBase):
    ...
    def data_parser() -> argparse.ArgumentParser:
        ...
        parser.add_argument('--prob_mri', type=float, default=0.5)
        ...
        parser.add_argument('--prob_pet', type=float, default=0.5)
    ...
    def train_parser() -> argparse.ArgumentParser:
        ...
        # MRI
        parser.add_argument('--optimizer_mri', type=str, default='sgd', choices=('sgd', 'adamw'),
                            help='Optimization algorithm.')
        parser.add_argument('--learning_rate_mri', type=float, default=0.001, help='Base learning rate to start from.')
        parser.add_argument('--weight_decay_mri', type=float, default=1e-4, help='Weight decay factor.')

        # PET
        parser.add_argument('--optimizer_pet', type=str, default='sgd', choices=('sgd', 'adamw'),
                            help='Optimization algorithm.')
        parser.add_argument('--learning_rate_pet', type=float, default=0.001, help='Base learning rate to start from.')
        parser.add_argument('--weight_decay_pet', type=float, default=1e-4, help='Weight decay factor.')
